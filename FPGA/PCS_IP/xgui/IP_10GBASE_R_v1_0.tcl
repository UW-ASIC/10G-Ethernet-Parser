...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "HEAD_W" -parent ${Page_0}
...
proc update_PARAM_VALUE.HEAD_W { PARAM_VALUE.HEAD_W } {
	# Procedure called to update HEAD_W when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.HEAD_W { PARAM_VALUE.HEAD_W } {
	# Procedure called to validate HEAD_W
	return true
}
...
proc update_MODELPARAM_VALUE.HEAD_W { MODELPARAM_VALUE.HEAD_W PARAM_VALUE.HEAD_W } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.HEAD_W}] ${MODELPARAM_VALUE.HEAD_W}
}
